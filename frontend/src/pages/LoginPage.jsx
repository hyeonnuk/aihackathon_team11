// ============================================================
//  LoginPage.jsx — /login
//  가짜 로그인(Fake Login): 이메일/비번 검사 없이
//  localStorage 에 유저 정보를 저장한 뒤 메인으로 이동
// ============================================================

import { useState } from 'react';
import { useNavigate } from 'react-router-dom';

// GitHub SVG 아이콘 (외부 라이브러리 없이 인라인으로 사용)
function GitHubIcon() {
  return (
...
export default function LoginPage() {
  ...
  // ── 가짜 로그인 핸들러 ──────────────────────────────────
  // 실제 API 호출 없이 localStorage 에 유저 정보를 세팅하고 이동
  const handleLogin = (e) => {
    e.preventDefault();
