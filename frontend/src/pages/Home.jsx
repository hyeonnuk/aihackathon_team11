...
// 한국 공휴일 (고정 + 2025~2026 음력 + 대체공휴일 포함)
const KR_HOLIDAYS = new Set([
  // 고정 공휴일
  '2025-01-01','2026-01-01',
  '2025-03-01','2026-03-01',
  '2025-05-05','2026-05-05',
  '2025-06-06','2026-06-06',
  ...
  // 2025 부처님오신날 (5/5) — 어린이날과 겹쳐 대체 5/6
  '2025-05-06',
  // 2025 추석 연휴 (10/5~7)
  ...
  // ── 대체공휴일 ──────────────────────────────────────────
  // 2025 삼일절(3/1 토) → 3/3 월
  '2025-03-03',
  // 2025 추석 연휴 첫날(10/5 일) → 10/8 수
  '2025-10-08',
  // 2026 삼일절(3/1 일) → 3/2 월
  '2026-03-02',
  // 2026 부처님오신날(5/24 일) → 5/25 월
  '2026-05-25',
  // 2026 현충일(6/6 토) → 6/8 월
  '2026-06-08',
  // 2026 광복절(8/15 토) → 8/17 월
  '2026-08-17',
  // 2026 개천절(10/3 토, 추석 연휴 겹침) → 10/8 목
  '2026-10-08',
]);
        ...
        >
          ...
          <FullCalendar
            ...
            dayCellClassNames={(arg) => {
              ...
              const classes = dateStr === selectedDate ? ['day-selected'] : [];
              if (KR_HOLIDAYS.has(dateStr)) classes.push('holiday-kr');
              return classes;
            }}
            eventContent={(arg) => (
              <div
